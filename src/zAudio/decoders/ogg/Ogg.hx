...
enum abstract OggWhence(Int) from Int to Int {
    var OGG_SEEK_SET = 0;
    var OGG_SEEK_CUR = 1;
    var OGG_SEEK_END = 2;
}
...
enum abstract OggWord(Int) from Int to Int {
    var TYPICAL = 2;
    var OGG_8_BIT = 1;
    var OGG_16_BIT = 2;
}
...
enum abstract OggSigned(Int) from Int to Int {
    var TYPICAL = 1;
    var OGG_UNSIGNED = 0;
    var OGG_SIGNED = 1;
}
...
enum abstract OggEndian(Int) from Int to Int {
    var TYPICAL = 0;
    var OGG_L_ENDIAN = 0;
    var OGG_B_ENDIAN = 1;
}
...
enum abstract OggCode(Int) from Int to Int {
    var OV_FALSE        = -1;
    var OV_EOF          = -2;
    var OV_HOLE         = -3;
